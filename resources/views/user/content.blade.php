                    ...
                    <ul class="navbar-nav ml-auto main-navbar-nav">
                            ...
                            <div class="hs-mega-menu main-sub-menu w-100" aria-labelledby="homeMegaMenu">
                                <div class="row no-gutters">
                                    <div class="col-lg-5 col-sm-6 col-12 gray-light-bg custom-radius-left">
                                        <div class="menu-item-wrap p-4">
                                            ...
                                            <p>Get your website, web store or application online using our reliable
                                                and fast hosting.</p>
                                            <ul class="list-unstyled content-feature-list mb-2">
                                                <li><i class="fad fa-check-circle text-success pr-2"></i>Managed
                                                    cloud</li>
                                                <li><i class="fad fa-check-circle text-success pr-2"></i>Business
                                                    continuity</li>
                                                <li><i class="fad fa-check-circle text-success pr-2"></i>IT/Cloud
                                                    consultancy</li>
                                                <li><i class="fad fa-check-circle text-success pr-2"></i>Load and
                                                    stress testing</li>
                                                <li><i class="fad fa-check-circle text-success pr-2"></i>Managed
                                                    Kubernetes</li>
                                                <li><i class="fad fa-check-circle text-success pr-2"></i>Managed
                                                ...
                                                <li><i class="fad fa-check-circle text-success pr-2"></i>Dedicated
                                                    connectivity</li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-7 col-sm-6 col-12 custom-radius-right">
                                        <div class="row no-gutters p-4">
                                            <div class="col-sm-12">
                                                <span class="sub-menu-title">Home Demos <small
                                                        class="badge badge-danger ml-2">New</small></span>
                                                <ul class="home-demo-list">
                                                    <li><a href="index.html"><i
                                                                class="fad fa-home-lg mr-2 text-danger"></i>Home
                                                            Default</a></li>
                                                    <li><a href="index-image.html"><i
                                                                class="fad fa-image mr-2 text-danger"></i>Home
                                                            Image</a></li>
                                                    <li><a href="index-slider.html"><i
                                                                class="fad fa-sliders-h-square mr-2 text-danger"></i>Home
                                                            Content Slider</a></li>
                                                    <li><a href="index-gaming.html"><i
                                                                class="fad fa-game-console-handheld mr-2 text-danger"></i>Home
                                                            Gaming Hosting</a></li>
                                                    <li><a href="index-video.html"><i
                                                                class="fad fa-video mr-2 text-danger"></i>Home
                                                            Background Video</a></li>
                                                    <li><a href="index-black-friday.html"><i
                                                                class="fad fa-hockey-mask mr-2 text-danger"></i>Home
                                                            Black Friday Sale</a></li>
                                                    <li><a href="index-black-friday-coming.html"><i
                                                                class="fad fa-dice-d6 mr-2 text-danger"></i>Home
                                                            Black Friday Coming</a></li>
                                                    <li><a href="index-top-navbar.html"><i
                                                                class="fad fa-grip-horizontal mr-2 text-danger"></i>Home
                                                            Top Navbar</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                ...
                                <div class="u-header__product-banner">
                                    <div class="u-header__product-banner-content text-center text-white">
                                        ...
                                        <a class="btn btn-brand-03" href="#">Get Started<span
                        ...
                        <li class="nav-item hs-has-sub-menu custom-nav-item">
                            ...
                            <ul id="pagesSubMenu" class="hs-sub-menu main-sub-menu" aria-labelledby="pagesMegaMenu"
                                ...
                                <li class="nav-item submenu-item">
                                    <a class="nav-link sub-menu-nav-link" href="terms-condition.html">Terms &
                                        Condition</a>
                                </li>
                                <li class="nav-item submenu-item">
                                    <a class="nav-link sub-menu-nav-link" href="privacy-policy.html">Privacy
                                        Policy</a>
                                </li>
                                <li class="hs-has-sub-menu">
                                    ...
                                    <ul id="navSubmenuPagesPricing" class="hs-sub-menu main-sub-menu"
                                        ...
                                        <li><a class="nav-link sub-menu-nav-link" href="pricing-package.html">Pricing
                                                Packages</a></li>
                                        <li><a class="nav-link sub-menu-nav-link" href="pricing-web-hosting.html">Web
                                                Hosting Packages</a></li>
                                        ...
                                        <li><a class="nav-link sub-menu-nav-link"
                                                href="pricing-specifications.html">Pricing Specifications <span
                                                    class="badge badge-danger ml-auto"> New</span></a></li>
                                ...
                                <li class="hs-has-sub-menu">
                                    ...
                                    <ul id="navSubmenuPagesSpecialty" class="hs-sub-menu main-sub-menu"
                                        ...
                                        <li><a class="nav-link sub-menu-nav-link"
                                                href="domain-search-result.html">Search Search Result <span
                                                    class="badge badge-warning ml-2">New</span></a></li>
                                        ...
                                        <li><a class="nav-link sub-menu-nav-link" href="coming-soon.html">Coming
                                                Soon</a></li>
                                        <li><a class="nav-link sub-menu-nav-link" href="thank-you.html">Thank
                                                You</a></li>
                                ...
                                <li class="hs-has-sub-menu">
                                    ...
                                    <ul id="navSubmenuPagesLogin" class="hs-sub-menu main-sub-menu"
                                        ...
                                        <li><a class="nav-link sub-menu-nav-link" href="password-reset.html">Recover
                                                Account</a></li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item hs-has-mega-menu custom-nav-item position-relative" data-position="center">
                            ...
                            <div class="hs-mega-menu main-sub-menu" style="width: 715px"
                                            ...
                                            <div class="title-with-icon-item">
                                                <a class="title-with-icon-link" href="cloud-hosting.html">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <span class="u-header__promo-title">Cloud Hosting
                                                            </span>
                                            ...
                                            <div class="title-with-icon-item">
                                                <a class="title-with-icon-link" href="windows-vps-hosting.html">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <span class="u-header__promo-title">Windows VPS
                                                                Hosting</span>
                                            ...
                                            <div class="title-with-icon-item">
                                                <a class="title-with-icon-link" href="dedicated-server-hosting.html">
                                                    <div class="media align-items-center">
                                                        ...
                                                        <div class="media-body">
                                                            <span class="u-header__promo-title">Dedicated Server
                                                                Hosting</span>
                                ...
                                <div class="application-hosting text-white">
                                    <span
                                        class="sub-menu-title text-lg-center text-md-center text-white mb-3">Application
                                        For Hosting</span>
                        ...
                        <li class="nav-item header-nav-last-item d-flex align-items-center">
                            <a class="btn btn-brand-03 animated-btn"
                                href="https://themetags.net/whmcs/?systpl=kohost-professional" target="_blank">
...
<div class="main">
    ...
    <!--hero section start-->
    <section class="myPadding gradient-bg">
        {{-- <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-7 col-lg-8">
                        <div class="hero-content-wrap text-white text-center position-relative">
                            <h1 class="text-white">Blog Single Right Sidebar</h1>
                        ...
                        <div class="post-wrapper">
                            ...
                            <div class="post-content">
                                ...
                                <blockquote class="blockquote">
                                    <p>To be yourself in a world that is constantly trying to make you something
                                        else is the greatest accomplishment.</p>
                            ...
                            <div class="post-footer">
                                <div class="post-tags"><a href="#">Lifestyle</a><a href="#">Music</a><a
                                        href="#">News</a><a href="#">Travel</a></div>
                            </div>
                        </div>
                    </article>
                    <!-- Post end-->
                            ...
                            <div class="comment">
                                ...
                                <div class="comment-body">
                                    ...
                                    <div class="comment-content">
                                        <p>Meh synth Schlitz, tempor duis single-origin coffee ea next level ethnic
                                            fingerstache fanny pack nostrud. Seitan High Life reprehenderit
                                            consectetur cupidatat kogi about me. Photo booth anim 8-bit hella, PBR 3
                                            wolf moon beard Helvetica.</p>
                                    </div>
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="comment-body">
                                            <div class="comment-meta">
                                                ...
                                                <div class="comment-meta-date"><a href="#">May 5, 2015 at 4:51
                                                        am</a></div>
                                            </div>
                                            <div class="comment-content">
                        ...
                        <div class="comment-respond">
                            ...
                            <form class="comment-form row">
                                ...
                                <div class="form-submit col-md-12">
                                    <button class="btn btn-brand-01" type="submit">Post Comment</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-4">
                    <div class="sidebar-right pl-4">
                        ...
                        <aside class="widget widget-recent-entries-custom">
                            ...
                            <ul>
                                <li class="clearfix">
                                    <div class="wi"><a href="blog-details.html"></a></div>
                                    <div class="wb"><a href="blog-details.html">Map where your photos were taken and
                                            discover local points.</a><span class="post-date">May 8, 2016</span>
                                    </div>
                                </li>
                                <li class="clearfix">
                                    <div class="wi"><a href="blog-details.html"></a></div>
                        ...
                        <aside class="widget widget-categories">
                            ...
                            <form action="#" method="post" class="d-none d-md-block d-lg-block">
                                ...
                                <button type="submit" class="btn btn-brand-01 btn-block mt-3">Subscribe</button>
                            </form>
                        </aside>
                        ...
                        <aside class="widget widget-tag-cloud">
                            ...
                            <div class="tag-cloud"><a href="#">e-commerce</a><a href="#">portfolio</a><a
                                    href="#">responsive</a><a href="#">bootstrap</a><a href="#">business</a><a
